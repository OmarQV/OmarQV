...
$ cat principles.txt
> The core computes. The evidence proves. The agent explains. The person decides.
...
| Year | Recognition |
| :--- | :--- |
| **2026** | 🥇 **1st place**, Real World Applications / HSK Chain track: Ethereum Bolivia Buildathon, Cochabamba (Vector52). |
| **2026** | ✨ **Tier 2 Contributor**, Stellar Ambassador Program. Selected for **Stellar Elite**. |
| **2026** | 🎓 **Aspire Institute** program completed with certificate. |
| **2025** | 🥇 **1st place**, CochaBlock Challenge: Destino Devconnect (AIni Pay). |
| **2025–26** | 🧑‍🤝‍🧑 Co-organizer of **Aleph Hackathon: La Paz chapter** and the **Vercel hackathon at UMSA**. |
...
<img src="https://skillicons.dev/icons?i=ts,js,react,nextjs,nodejs,python,fastapi,solidity,docker,git,linux,postgres,supabase,tailwind,vercel,blender&perline=8" alt="TypeScript, JavaScript, React, Next.js, Node.js, Python, FastAPI, Solidity, Docker, Git, Linux, PostgreSQL, Supabase, Tailwind CSS, Vercel and Blender" />
...
<sub>Generated daily by <a href="https://github.com/yoshi389111/github-profile-3d-contrib">GitHub Profile 3D Contrib</a>. Activity is one signal, not a measure of expertise.</sub>
...
- 🎓 **Informatics, Information Security track** at Universidad Mayor de San Andrés (UMSA). Now in 8th semester: risk management, information-asset management and systems auditing.
- 📚 Also trained in **public accounting**, which gives me a useful lens for controls, traceability and auditability.
...
<strong>Open to collaborations, hackathon teams and roles in AI agents, Web3 and security.</strong><br />
